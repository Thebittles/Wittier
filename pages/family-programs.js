...
const tags = ["Summer Programs"];

export default function NewsPage() {
  const [selectedTag, setSelectedTag] = useState("Summer Programs");
  ...
  useEffect(() => {
    async function fetchGoogleSearchLightResults() {
      ...
      try {
        ...
        setSmsMessage(`🏕️ Family & Summer Programs - ${selectedTag}:\n${smsText}`);
      } catch (error) {
  ...
  return (
    ...
    <div className="p-6 container">
      <h1 className="text-2xl font-bold mb-4">Family Programs</h1>
